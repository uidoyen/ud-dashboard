...
//.controller("udLoginController", ['$scope', '$firebaseSimpleLogin', 'FBURL', function($scope,$firebaseSimpleLogin ,FBURL){
.controller('udLoginController', ['$scope','FBURL','$window', '$rootScope', function($scope, FBURL, $window, $rootScope){
